...
SELECT customers.company_name AS customer_company, CONCAT(employees.first_name, ' ', employees.last_name) AS full_name
FROM customers
JOIN employees ON customers.city = employees.city AND customers.city = 'London'
